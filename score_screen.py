...
class ScoreScreen:
    ...
    def draw(self):
        ...
        time_surface = self.text_font.render(f"Time: {self.final_time:.2f}s", True, (0, 255, 255))
        time_rect = time_surface.get_rect(center=(400, 240))
        self.screen.blit(time_surface, time_rect)

        score_surface = self.text_font.render(f"Score: {self.final_score}", True, (0, 255, 255))
